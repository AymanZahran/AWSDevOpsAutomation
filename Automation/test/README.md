...
1. Write the JSON schema describing your resource, `aws-apigateway-authorizer.json`
2. Implement your resource handlers in `aws_apigateway_authorizer/handlers.py`
